...
namespace Hashtable
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ht.Print();
            //Check for Key values in Hashmap
            Console.WriteLine($"Size of hashmap: {ht.Size}");
        ...
        {
            //read only for a serial of prime numbers
            ...
            //HashTable initialization and Comparing the Tkey as Default
            public HashTable()
            {
                Initialize(0);
            ...
            {
                //Applying methods of Get and Set for finding the entries and for default entries
                get
                {
                    int i = FindEntry(key);
            ...
            //Capacity Parameter Constructor
            ...
            //Input for insertion of TKey and TValue
